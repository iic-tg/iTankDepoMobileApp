...
public class SpinnerCustomAdapter_Cargo extends ArrayAdapter<String> {

    private Activity activity;
    private ArrayList data;
    Previous_CargoDropdownBean tempValues=null;
    LayoutInflater inflater;

    /*************  CustomAdapter Constructor *****************/
    public SpinnerCustomAdapter_Cargo(
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        tempValues = null;
        tempValues = (Previous_CargoDropdownBean) data.get(position);
