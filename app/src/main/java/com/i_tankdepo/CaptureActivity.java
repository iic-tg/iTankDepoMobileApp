...
import com.i_tankdepo.language.LanguageCodeHelper;
import com.i_tankdepo.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ...
  private Button im_add,im_print,home,refresh;
  ...
  public void onCreate(Bundle icicle) {
    ...
    Log.i("pendingsize===>", String.valueOf(pendingsize));
//    im_print.setVisibility(View.GONE);
    ...
    im_skip.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        GlobalConstants.pendingcount=pendingsize;
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    final TextView ocrResultTextView = (TextView) findViewById(R.id.ocr_result_text_view);
    ocrResultTextView.setText(ocrResult.getText());
    Button ok=(Button)findViewById(R.id.get_text);
